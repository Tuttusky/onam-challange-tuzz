...
class PottuSettingController extends Controller
{
    public function edit(): View
    {
        $settings = PottuSettingsService::globalSettings();

        return view('admin.settings.pottu', compact('settings'));
    }
    ...
    public function update(Request $request): RedirectResponse
    {
        ...
        WebsiteSettingsService::set('pottu_settings', [
        ...
        return back()->with('success', 'Pottu settings updated.');
    }
}
